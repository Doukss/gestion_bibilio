    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-center">Liste des Rayon</h2>
                <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors btn"onclick="my_modal_1.showModal()">
                    Nouveau
                </button>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col">
                    <img src="./asset/illustration-colonne-vertebrale-du-livre-dessine-main_23-2149329859.avif" alt="Couverture du livre" class="mb-2 w-full h-40 object-cover">
                    <h3 class="text-lg font-semibold"><?= htmlspecialchars($rayon['nom']) ?></h3>
                ...
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col">
                    ...
                    <div class="flex justify-between border-t border-gray-300 pt-4 mt-auto">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="#" class="p-2 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-colors" title="Supprimer">
                                <i class="ri-delete-bin-line"></i>
                            </a>
                        </div>
                    </div>
